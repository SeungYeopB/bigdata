...
driver.find_element_by_xpath('//*[@id="id"]').send_keys('study0610') # id  입력
driver.find_element_by_xpath('//*[@id="pw"]').send_keys('gkgkgk@10') # password 입력
driver.find_element_by_xpath('//*[@id="log.login"]').click()

# 두번째 방법 - clipboard 사용
# pip install pyperclip
# github.com/lumyjuwon/NaverCaptcha 참조
import pyperclip
from selenium.webdriver.common.keys import Keys

driver.find_element_by_xpath('//*[@id="account"]/a').click()
pyperclip.copy('study0610') # my id
driver.find_element_by_xpath('//*[@id="id"]').send_keys(Keys.CONTROL, 'v') # id  입력
pyperclip.copy('gkgkgk@10') # password
driver.find_element_by_xpath('//*[@id="pw"]').send_keys(Keys.CONTROL, 'v') # password 입력
driver.find_element_by_xpath('//*[@id="log.login"]').click()
...
## https://myfeed.naver.com/index.nhn
## web site 정보를 크롤링
## login + crawling pgm
## 제목, 작성자, 작성날짜, 종류, 미리보기 내용, url 정보, 정보상세내역
## csv format으로 해서 crawl.csv 저장
## 오늘 + 주말에 작업 해보시고 월요일 맞춰보기 합니다.
